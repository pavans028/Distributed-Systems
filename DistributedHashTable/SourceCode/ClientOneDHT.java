...
/**
* The PeerAsServerDHT program is a server part of a 1st client
...
class PeerOneAsServerDHT implements Runnable {
	...
	private static ObjectOutputStream osForEachClient[] = new ObjectOutputStream[10];; // separate object output stream for each client
	private static ObjectInputStream inForEachClient[] = new ObjectInputStream[10];; // separate object input stream for each client
	private int i=0;
	// Constructor to initialize each client and make it as a separate thread
	public PeerOneAsServerDHT() {
...
/**
* The ClientOneDHT program acts a 1st
