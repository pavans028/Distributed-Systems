...
/**
* The PeerSevenAsServerDHT program is a server part of a 7th client
...
class PeerSevenAsServerDHT implements Runnable {
	...
	public void run() {
		...
		try {
			...
			String ipAddress = properties.getProperty("ipAddressPeerSeven"); //ipaddress to host client server
...
/**
* The ClientSevenDHT program acts a 7th
