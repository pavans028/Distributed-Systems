...
/**
* The PeerEightAsServerDHT program is a server part of a 8th client
...
class PeerEightAsServerDHT implements Runnable {
	...
	public void run() {
		...
		try {
			...
			String ipAddress = properties.getProperty("ipAddressPeerEight"); //ipaddress to host client server
...
/**
* The ClientEightDHT program acts a 8th
