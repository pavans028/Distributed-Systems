...
/**
* The PeerSixAsServerDHT program is a server part of a 6th client
...
class PeerSixAsServerDHT implements Runnable {
	...
	public void run() {
		...
		try {
			...
			String ipAddress = properties.getProperty("ipAddressPeerSix"); //ipaddress to host client server
...
/**
* The ClientSixDHT program acts a 6th
