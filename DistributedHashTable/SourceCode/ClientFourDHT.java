...
/**
* The PeerFourAsServerDHT program is a server part of a 4th client
...
class PeerFourAsServerDHT implements Runnable {
	...
	public void run() {
		...
		try {
			...
			String ipAddress = properties.getProperty("ipAddressPeerFour"); //ipaddress to host client server
			...
			distHashMapOfPeers = new ConcurrentHashMap<String, String>(50);
...
/**
* The ClientFourDHT program acts a 4th
...
public class ClientFourDHT {
	...
	public static void main(String[] args) throws IOException {
		try{
			...
			//System.out.println("No of servers connected-->"+availablePeers.size()+"-->"+availablePeers);
			
			// Start the server for other clients to connect for file sharing
			new PeerFourAsServerDHT();
			noOfServers = 8;
