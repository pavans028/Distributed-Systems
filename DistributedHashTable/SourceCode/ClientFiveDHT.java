...
/**
* The PeerFiveAsServerDHT program is a server part of a 5th client
...
class PeerFiveAsServerDHT implements Runnable {
	...
	public void run() {
		...
		try {
			...
			String ipAddress = properties.getProperty("ipAddressPeerFive"); //ipaddress to host client server
...
/**
* The ClientFiveDHT program acts a 8th
